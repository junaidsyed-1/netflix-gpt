...
const Header = () => {
    ...
    return (
        <div className="absolute flex flex-col md:flex-row bg-gradient-to-b from-black w-full z-10 justify-between items-center top-0">
            <div className="m-3">
                <img
                    className="w-36"
                    src={LOGO} alt="Logo" />
            </div>
            {
                user &&
                <>
                    <div className="m-3 relative z-50">
